"""Reinstate living_type_allowances for the apartment-insights feature.

Revision ID: 0010_living_type_allowances
Revises: 0009_occupancy_snapshots
...
revision: str = "0010_living_type_allowances"
down_revision: str | Sequence[str] | None = "0009_occupancy_snapshots"
